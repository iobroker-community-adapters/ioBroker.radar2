...
const {Network, Bluetooth, ScanCmd} = require('../myNetworks');
...
async function main() {
    ...
    /*
        ...
        */
    await bluetooth.startScan(["44:78:3e:ca:c2:da","ac:af:b9:9d:ba:1b","7c:2f:80:99:c9:b6","7c:2f:80:99:c9:d1","00:1d:a5:00:02:20"]);
    //    await 
